...
#来自 https://github.com/oarriaga/face_classification/blob/master/src/models/cnn.py
...
# from https://github.com/ebarsoum/FERPlus/blob/master/src/models.py
def GitHub_model(input_shape, num_classes):
    img_input = Input(input_shape)
    x = Conv2D(64, (3, 3), strides=(1, 1),padding='same')(img_input)
    x = BatchNormalization()(x)
    x = Activation('relu',)(x)
